              ...
              <div className="flex flex-1 flex-col gap-3 p-5">
                ...
                <div className="mt-auto grid grid-cols-3 gap-2 border-t border-cyan-100 pt-3 dark:border-white/10">
                  ...
                  <button
                    ...
                    disabled={busyId === m._id}
                    className="h-8 w-full whitespace-nowrap rounded-lg bg-slate-100 px-2 py-1.5 text-[10px] font-semibold text-slate-700 ring-1 ring-slate-300 transition hover:bg-slate-200 disabled:opacity-50 dark:bg-slate-700/55 dark:text-slate-100 dark:ring-white/15 dark:hover:bg-slate-700"
                  >
