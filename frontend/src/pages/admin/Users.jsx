    ...
    <Card>
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          />
          <button onClick={load} className="rounded-lg bg-brand-500 px-3 py-2 text-sm font-bold">Buscar</button>
        </div>
      </div>
      <div className="mt-4 flex items-center gap-3">
        <button
          ...
          className="rounded-lg bg-brand-500 px-3 py-2 text-xs font-bold"
        >
          Generar codigo docente
        </button>
        {teacherCode && <span className="text-xs text-brand-200">Codigo: {teacherCode}</span>}
      </div>
